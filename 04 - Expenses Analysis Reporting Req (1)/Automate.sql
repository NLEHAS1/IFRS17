...
Create or replace table mireporting.CashflowsMetrics as 
select
  a.ValuationDate,
  a.CohortYear,
...
Insert into mireporting.CashflowsMetrics 
select * from (
select
  a.ValuationDate,
  a.CohortYear,
...
Create or replace table mireporting.CashflowsSubTypeMetrics as 
WITH FxRates as (
        select distinct ValuationDate,ValuationDate as EffectFromDate,ValuationDate as EffectToDate,CalculationEntity,'EUR' as FromCurrency, 'EUR' as  ToCurrency, 1 as ConversionRate,ConversionType,DataSource,Context 
...
CTE0 as (
  ...
  sum(Amount) as Amount
  from
  MI2022.cashflows_201912_20220603_000035_370
  group by
  ContractId,
  CashFlowId,
  CashFlowType,
...
Insert into mireporting.CashflowsSubTypeMetrics 
select * from (
WITH FxRates as (
        select distinct ValuationDate,ValuationDate as EffectFromDate,ValuationDate as EffectToDate,CalculationEntity,'EUR' as FromCurrency, 'EUR' as  ToCurrency, 1 as ConversionRate,ConversionType,DataSource,Context 
        from    MI2022.fxrates_201912_20220603_000035_370
