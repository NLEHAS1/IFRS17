...
-- MAGIC %md The changes had been implented to cashflowsubmetrics but not to cashflowsmetrics, you just need to run the code
      ...
      (
        ...
        CTE3 as (
          ...
          select
            a.*,
            to_date(
      cast(Left(CustomCashflowDate, 6) as string),
      'yyyyMM'
    ) as CashflowMonth,
            case
...
Use db_202009_20220610_000047_501;
