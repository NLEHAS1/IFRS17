...
Create view MI2022.Control1b_20201231_v20220419_01 as 
with MaximumCreditTerms as (
  ...
  from
    ...
    Inner JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20201231_v20220419_01 ctrygrp on (
...
MaximumCreditPeriod as (
  ...
  FROM
    MI2022.TBPO_POL_VERSIONS_SL1_20201231_v20220419_01 pol
    JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20201231_v20220419_01 ctrygrp on (
      ctrygrp.bupiy_id = pol.Bupiy_id
      AND pol.end_risk_dat BETWEEN ctrygrp.effect_from_dat
      AND ctrygrp.effect_to_dat
    )
...
RunoffCover as (
  ...
  From
    MI2022.TBPO_POL_VERSIONS_SL1_20201231_v20220419_01 pol
    left join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20201231_v20220419_01 pvar on (
      pol.bupiy_Id = pvar.bupiy_Id
      and pol.end_risk_dat BETWEEN pvar.effect_from_dat
      AND pvar.effect_to_dat
    )
    Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20201231_v20220419_01 refmodvar On pvar.porve_code = refmodvar.porve_code
  Where
    (
...
From
  MI2022.Contracts_SL1_20201231_v20220419_01 a
  left join MI2022.TBPO_POL_MODULES_SL1_20201231_v20220419_01 mod on mod.Bupiy_Id = a.PolicyId
  Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20201231_v20220419_01 refmodvar On (
    mod.porce_code = refmodvar.porce_code
    and mod.porme_Code = refmodvar.porme_code
  )
  Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20201231_v20220419_01 modvar On (
    ...
    from
      (
        ...
        From
          ...
          Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20201231_v20220419_01 mref On pmod.porme_code = mref.porme_code
          And pmod.porce_code = mref.Porce_code
          Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20201231_v20220419_01 mvar On pmod.Bupiy_Id = mvar.Bupiy_Id
  ...
  Left Join MI2022.TBBU_POLICIES_SL1_20201231_v20220419_01 i on a.policyid = i.id
  left join MI2022.TBPO_POL_VERSIONS_SL1_20201231_v20220419_01 g on (
...
select count(*) from MI2022.Control1b_20201231_v20220419_01

-- COMMAND ----------

select * from MI2022.Control1b_20201231_v20220419_01 where policyid=980205
