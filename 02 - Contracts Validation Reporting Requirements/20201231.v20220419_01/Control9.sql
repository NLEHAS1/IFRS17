...
Create view MI2022.Control9Int_20201231_v20220419_01 as
select * from MI2022.Contracts_SL1_20201231_v20220419_01 where ManagedTogetherId in (select
  ManagedTogetherId
from
  MI2022.Contracts_SL1_20201231_v20220419_01
where
  DataSource='SYM' and RiskPeriodEndDate > 20200930
group by
  ManagedTogetherId
having
...
-- COMMAND ----------
  ...
  create view MI2022.Control9_20201231_v20220419_01 as
select
  a.*,
...
from
  ...
  left join MI2022.TBBU_POLICIES_SL1_20201231_v20220419_01 b on a.PolicyId = b.id
  Left join MI2022.TBOR_NON_NCM_ORGANISATIONS_SL1_20201231_v20220419_01 c on c.ID = b.ORCUR_ORNNN_ID
  and c.Effect_To_Dat > Current_Date()
  left join MI2022.TBPO_POL_GROUP_POLICIES_SL1_20201231_v20220419_01 d on ( a.policyid = d.bupiy_id
...
from
  MI2022.Contracts_SL1_20201231_v20220419_01
where
  DataSource='SYM' and RiskPeriodEndDate > 20201231
group by
  ManagedTogetherId
having
  count(distinct mainunit) > 1
