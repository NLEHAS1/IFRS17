...
drop view MI2022.Control1a_20201231_v20220419_01

-- COMMAND ----------

Create view MI2022.Control1a_20201231_v20220419_01 as 
...
From
  ...
  Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20201231_v20220419_01 refmodvar On (mod.porce_code = refmodvar.porce_code and mod.porme_Code = refmodvar.porme_code)
  Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20201231_v20220419_01 modvar On (refmodvar.porve_Code = modvar.porve_code and mod.bupiy_id = modVar.Bupiy_id)
  --Drivers
  --MaximumCreditTerms
  ...
  left join MI2022.TBPO_POL_VERSIONS_SL1_20201231_v20220419_01 g on (a.policyid = g.bupiy_id and to_date(g.start_risk_dat, 'yyyyMMdd') = to_date(cast(a.ContractIssueDate as string), 'yyyyMMdd')) 
Where
  mod.porce_Code = 'C00'
...
select * from MI2022.Control1a_20201231_v20220419_01 where policyid=980205
