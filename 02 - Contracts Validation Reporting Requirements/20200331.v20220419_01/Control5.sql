...
create view MI2022.Control5_20200331_v20220419_01 as
select
  a.*,
...
from
  ...
  left join MI2022.TBPO_POL_GROUP_POLICIES_SL1_20200331_v20220419_01 d on (
...
select count(*) from MI2022.Control5_20200331_v20220419_01
