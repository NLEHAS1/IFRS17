...
Create view MI2022.Control1a_20200930_v20220419_01 as 
with MaximumCreditTerms as (
  ...
  from
    MI2022.TBPO_POL_VERSIONS_SL1_20200930_v20220419_01 pol
    Inner JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20200930_v20220419_01 ctrygrp on (
...
MaximumCreditPeriod as (
  ...
  FROM
    MI2022.TBPO_POL_VERSIONS_SL1_20200930_v20220419_01 pol
    JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20200930_v20220419_01 ctrygrp on (
      ctrygrp.bupiy_id = pol.Bupiy_id
      AND pol.end_risk_dat BETWEEN ctrygrp.effect_from_dat
      AND ctrygrp.effect_to_dat
    )
...
From
  MI2022.Contracts_SL1_20200930_v20220419_01 a
  left join MI2022.TBPO_POL_MODULES_SL1_20200930_v20220419_01 mod on mod.Bupiy_Id = a.PolicyId
  Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20200930_v20220419_01 refmodvar On (mod.porce_code = refmodvar.porce_code and mod.porme_Code = refmodvar.porme_code)
  Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20200930_v20220419_01 modvar On (refmodvar.porve_Code = modvar.porve_code and mod.bupiy_id = modVar.Bupiy_id)
  --Drivers
  --MaximumCreditTerms
  ...
  Left Join (SELECT
            ...
            FROM
            MI2022.TBPO_POL_VERSIONS_SL1_20200930_v20220419_01 pol
            JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20200930_v20220419_01 ctrygrp on (ctrygrp.bupiy_id = pol.bupiy_id AND pol.end_risk_dat BETWEEN ctrygrp.effect_from_dat AND ctrygrp.effect_to_dat)
            where
  ...
  Left Join (SELECT
            ...
            FROM
            MI2022.TBPO_POL_VERSIONS_SL1_20200930_v20220419_01 pol
            JOIN MI2022.TBPO_CTRY_GRP_COVER_PCTS_SL1_20200930_v20220419_01 ctrygrpcvr on (
  ...
  left join (select * from (Select
            ...
            From MI2022.TBBU_POLICIES_SL1_20200930_v20220419_01 a
            left join MI2022.TBPO_POL_MODULES_SL1_20200930_v20220419_01 pmod on pmod.bupiy_id=a.id
            Left  Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20200930_v20220419_01 mref
            On pmod.porme_code = mref.porme_code
            And pmod.porce_code = mref.Porce_code
            Left  Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20200930_v20220419_01 mvar
  ...
  --NoCoverPeriod
  Left Join MI2022.TBBU_POLICIES_SL1_20200930_v20220419_01 i on a.policyid=i.id
  left join MI2022.TBPO_POL_VERSIONS_SL1_20200930_v20220419_01 g on (a.policyid = g.bupiy_id and to_date(g.start_risk_dat, 'yyyyMMdd') = to_date(cast(a.ContractIssueDate as string), 'yyyyMMdd')) 
Where
  mod.porce_Code = 'C00'
  ...
  And a.RiskPeriodEndDate > 20200930
  And a.DataSource = 'SYM'

-- COMMAND ----------

select count(*) from MI2022.Control1a_20200930_v20220419_01 

-- COMMAND ----------

select * from MI2022.Control1a_20200930_v20220419_01 
