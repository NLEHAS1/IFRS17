...
create view MI2022.Control9_20191231_v20220529_01 as
with Control9Int (
select * from MI2022.Contracts_SL1_20191231_v20220529_01 where ManagedTogetherId in (select
  ManagedTogetherId
from
  MI2022.Contracts_SL1_20191231_v20220529_01
where
  DataSource='SYM' and CoverEndDate >= 20200101
group by
  ManagedTogetherId
having
...
from
  ...
  left join MI2022.TBPO_POL_GROUP_POLICIES_SL1_20191231_v20220529_01 d on ( a.policyid = d.bupiy_id
