...
Create view MI2022.Control1b_20191231_v20220529_01 as 
with MaximumCreditTerms as (
  ...
  From
    MI2022.TBPO_POL_VERSIONS_SL1_20191231_v20220529_01 pvs
    Left Join MI2022.TBPO_CTRY_GRP_MCTS_SL1_20191231_v20220529_01 ctry On pvs.bupiy_id = ctry.Bupiy_id
...
MaximumCreditPeriod as (
  SELECT
    ...
    pol.start_risk_dat
  FROM
    MI2022.TBPO_POL_VERSIONS_SL1_20191231_v20220529_01 pol
    JOIN MI2022.TBPO_CTRY_GRP_MCTS_SL1_20191231_v20220529_01 ctrygrp on (
...
RunoffCover as (
  ...
  From
    MI2022.TBPO_POL_VERSIONS_SL1_20191231_v20220529_01 pol
    left join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20191231_v20220529_01 pvar on (
      pol.bupiy_Id = pvar.bupiy_Id
      and pol.end_risk_dat BETWEEN pvar.effect_from_dat
      AND pvar.effect_to_dat
    )
    Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20191231_v20220529_01 refmodvar On pvar.porve_code = refmodvar.porve_code
  Where
    (
...
From
  ...
  left join MI2022.TBPO_POL_MODULES_SL1_20191231_v20220529_01 mod on mod.Bupiy_Id = a.PolicyId
  Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20191231_v20220529_01 refmodvar On (
    mod.porce_code = refmodvar.porce_code
    and mod.porme_Code = refmodvar.porme_code
  )
  Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20191231_v20220529_01 modvar On (
  ...
  Left Join (
    ...
    FROM
      MI2022.TBPO_POL_VERSIONS_SL1_20191231_v20220529_01 pol
      JOIN MI2022.TBPO_CTRY_GRP_COVER_PCTS_SL1_20191231_v20220529_01 ctrygrpcvr on (
  ...
  left join (
    ...
    from
      (
        ...
        From
          MI2022.TBBU_POLICIES_SL1_20191231_v20220529_01 a
          left join MI2022.TBPO_POL_MODULES_SL1_20191231_v20220529_01 pmod on pmod.bupiy_id = a.id
          Left Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20191231_v20220529_01 mref On pmod.porme_code = mref.porme_code
          And pmod.porce_code = mref.Porce_code
          Left Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20191231_v20220529_01 mvar On pmod.Bupiy_Id = mvar.Bupiy_Id
  ...
  left join (
    ...
    from
      MI2022.Contracts_SL1_20191231_v20220529_01
    where
  ...
  Left Join MI2022.TBBU_POLICIES_SL1_20191231_v20220529_01 i on a.policyid = i.id
  left join MI2022.TBPO_POL_VERSIONS_SL1_20191231_v20220529_01 g on (
...
select count(*) from MI2022.Control1b_20191231_v20220529_01
