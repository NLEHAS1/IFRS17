...
Create view MI2022.Control3_20191231_v20220529_01 as
select
  *
from
  (
    ...
    From
      ...
      left join MI2022.TBPO_POL_MODULES_SL1_20191231_v20220529_01 pmod on a.PolicyId = pmod.Bupiy_Id
      Left Outer Join MI2022.TBPO_REF_MODULE_VARIABLE_TYPES_SL1_20191231_v20220529_01 mref On (
        pmod.porme_code = mref.porme_code
        And pmod.porce_code = mref.Porce_code
      )
      Left Outer Join MI2022.TBPO_POL_MOD_VARIABLES_SL1_20191231_v20220529_01 mvar On (
...
select count(*) from  MI2022.Control3_20191231_v20220529_01
