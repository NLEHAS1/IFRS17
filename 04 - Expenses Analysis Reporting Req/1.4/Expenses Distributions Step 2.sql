...
--In this step I only included CashflowNature
...
CTECT as (
  ...
  from
    ...
    inner join Mi2022.CONTRACT_TYPE_201912_20220413_133443_206 b on (
      ...
      and calculationentity = 001 and direct_contract_flg = 1)
),
...
select sum(customvalue) from MI2022.StartingPointReports_201912_20220413_133443_206 where calculationentity=001 and cohortyear=2003 and contracttype='Direct Contract' and cashflownature='Future Cashflow' and Cashflowtype='P'
...
select * from mi2022.expenseanalysisagg2

-- COMMAND ----------

select contractissuedate from MI2022.contracts_201912_20220413_133443_206 order by  contractissuedate desc
