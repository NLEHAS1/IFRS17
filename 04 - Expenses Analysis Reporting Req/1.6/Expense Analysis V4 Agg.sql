...
select * from  mireporting.expenseanalysis_1_6_Agg
...
select ValuationDate, RiskPeriodStartMonth,RiskPeriodStartYear, CohortYear,MainUnit, CashflowNature, MainProduct, count(*) from mireporting.expenseanalysis_1_6_Agg group by 
ValuationDate, RiskPeriodStartMonth,RiskPeriodStartYear, CohortYear,MainUnit, CashflowNature, MainProduct having count(*)>1
...
Insert into mireporting.expenseanalysis_1_6_Agg
select * from (
select
  a.ValuationDate,
  a.CohortYear,
      ...
      (
        ...
        CTE0 as (
          SELECT
            ...
            sum(Amount) as Amount
          from
            MI2022.cashflows2_202003_20220528_010617_250
          group by
            ContractId,
            CashFlowId,
            CashFlowType,
        ...
        CTE2 as (
          ...
          from
            CTE1 a
            LEFT JOIN MI2022.FxRates3_202003_20220528_010617_250 e on (
              TransactionCurrency = e.FromCurrency
              and e.ToCurrency = 'EUR'
              and e.ValuationDate = e.EffectToDate
            ) ---> Future Cashflows
            LEFT JOIN MI2022.FxRates3_202003_20220528_010617_250 f on (
              TransactionCurrency = f.FromCurrency
              and f.ToCurrency = 'EUR'
              and CustomCashflowDate = f.EffectToDate
            ) ---> Actual Cashflows
...
select distinct valuationdate from mireporting.expenseanalysis_1_6_Agg
    ...
    from
      (
        ...
        CTE2 as (
          ...
          from
            CTE1 a
            LEFT JOIN MI2022.FxRates3_202006_20220528_010617_251 e on (
              TransactionCurrency = e.FromCurrency
              and e.ToCurrency = 'EUR'
              and e.ValuationDate = e.EffectToDate
            ) ---> Future Cashflows
            LEFT JOIN MI2022.FxRates3_202006_20220528_010617_251 f on (
              TransactionCurrency = f.FromCurrency
              and f.ToCurrency = 'EUR'
              and CustomCashflowDate = f.EffectToDate
            ) ---> Actual Cashflows
    ...
    from
      (
        ...
        CTE2 as (
          ...
          from
            CTE1 a
            LEFT JOIN MI2022.FxRates3_202009_20220528_010617_252 e on (
              TransactionCurrency = e.FromCurrency
              and e.ToCurrency = 'EUR'
              and e.ValuationDate = e.EffectToDate
            ) ---> Future Cashflows
            LEFT JOIN MI2022.FxRates3_202009_20220528_010617_252 f on (
              TransactionCurrency = f.FromCurrency
              and f.ToCurrency = 'EUR'
              and CustomCashflowDate = f.EffectToDate
            ) ---> Actual Cashflows
    ...
    from
      (
        ...
        CTE2 as (
          ...
          from
            CTE1 a
            LEFT JOIN MI2022.FxRates3_202012_20220528_010617_253 e on (
              TransactionCurrency = e.FromCurrency
              and e.ToCurrency = 'EUR'
              and e.ValuationDate = e.EffectToDate
            ) ---> Future Cashflows
            LEFT JOIN MI2022.FxRates3_202012_20220528_010617_253 f on (
              TransactionCurrency = f.FromCurrency
              and f.ToCurrency = 'EUR'
              and CustomCashflowDate = f.EffectToDate
            ) ---> Actual Cashflows
...
desc extended mireporting.expenseanalysis_1_6_Agg 
