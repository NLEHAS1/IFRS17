...
Create or replace table mireporting.expenseanalysis_1_8_Agg as 
select
  a.ValuationDate,
  a.CohortYear,
  ...
  (
    ...
    from
      (
        ...
        from    MI2022.fxrates_201912_20220603_000035_370
        union all 
        select * from MI2022.fxrates_201912_20220603_000035_370
         ...
         DateDistributionsTrans as (
          with Datedistributionsint as (
            ...
            from
              MI2022.datedistributions_201912_20220603_000035_370
          ),
        ...
        CTE0 as (
          ...
          from
            MI2022.cashflows_201912_20220603_000035_370 where Datasource != 'RE2021'
          group by
            ContractId,
            CashFlowId,
            CashFlowType,
        ...
        CTE1 as(
          ...
          from
            MI2022.contracts_201912_20220603_000035_370 a
            ...
            LEFT JOIN MI2022.Entities_201912_20220603_000035_370 g on (a.InsurerId = g.InsurerId)
            LEFT JOIN MI2022.Entities_201912_20220603_000035_370 h on (a.InsuredId = h.InsurerId)
            LEFT JOIN MI2022.Entities_201912_20220603_000035_370 i on (c.FromPartyId = i.InsurerId)
            LEFT JOIN MI2022.Entities_201912_20220603_000035_370 j on (c.ToPartyId = j.InsurerId)
          where
...
select * from mireporting.expenseanalysis_1_8_Agg

-- COMMAND ----------

select count(*) from mireporting.expenseanalysis_1_8_Agg

-- COMMAND ----------

select distinct valuationdate from mireporting.expenseanalysis_1_8_Agg
...
-- COMMAND ----------
    ...
    select * from CTE3  where   TransactionCurrency='EUR' and CashflowNature='Future Cashflow'
...
select *
          from
            MI2022.cashflows_201912_20220603_000035_370 where CashFlowId=4744191397981212660 and contractid='SYM / 926965 / 20160301'

-- COMMAND ----------

select * from MI2022.fxrates_201912_20220603_000035_370 where fromcurrency='AED' and tocurrency='EUR' and effecttodate=20191231
