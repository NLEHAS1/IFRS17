...
-- MAGIC %md ###1.201912_20220618_000034_598

-- COMMAND ----------

use db_201912_20220618_000034_598;
...
Create or replace table mireporting.CashflowsMetrics_1_12 as 
select
  a.ValuationDate,
  a.CohortYear,
...
select * from mireporting.CashflowsMetrics_1_12 

-- COMMAND ----------

select count(*) from mireporting.CashflowsMetrics_1_12

-- COMMAND ----------

select distinct valuationdate from mireporting.CashflowsMetrics_1_12

-- COMMAND ----------

-- MAGIC %md ###2.202003_20220618_000034_599

-- COMMAND ----------

Use db_202003_20220618_000034_599;

-- COMMAND ----------

Insert into mireporting.CashflowsMetrics_1_12
select * from (
select
  a.ValuationDate,
  a.CohortYear,
...
-- MAGIC %md ###3.202006_20220618_000034_600

-- COMMAND ----------

use db_202006_20220618_000034_600;
...
-- MAGIC %md ###4.202009_20220618_000034_601

-- COMMAND ----------

Use db_202009_20220618_000034_601;
...
-- MAGIC %md ###5.202012_20220618_000034_602

-- COMMAND ----------

Use db_202012_20220618_000034_602;
...
Create or replace table mireporting.CashflowsSubTypeMetrics_1_12 as 
WITH FxRates as (
        select distinct ValuationDate,ValuationDate as EffectFromDate,ValuationDate as EffectToDate,CalculationEntity,'EUR' as FromCurrency, 'EUR' as  ToCurrency, 1 as ConversionRate,ConversionType,DataSource,Context 
        from    fxrates
        union all 
...
select * from mireporting.CashflowsSubTypeMetrics_1_12

-- COMMAND ----------

select count(*) from mireporting.CashflowsSubTypeMetrics_1_12

-- COMMAND ----------

select distinct valuationdate from mireporting.CashflowsSubTypeMetrics_1_12
...
Insert into mireporting.CashflowsSubTypeMetrics_1_12
select * from (
WITH FxRates as (
        select distinct ValuationDate,ValuationDate as EffectFromDate,ValuationDate as EffectToDate,CalculationEntity,'EUR' as FromCurrency, 'EUR' as  ToCurrency, 1 as ConversionRate,ConversionType,DataSource,Context 
        from    fxrates
